...
def rep_with_other(s):
    newList = list(s)
    randomLetter = random.randint(0, len(newList))
    newList[randomLetter] = newList[randomLetter].upper()
    x = "".join(newList)
    return x
...
print("One letter is upper version of the password:", rep_with_other("".join(passwordList)))
print("Final version of the password:", swap_letters("".join(passwordList)))
print(search_letter("".join(passwordList), 'e'))
